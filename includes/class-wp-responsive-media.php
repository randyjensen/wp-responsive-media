...
class WP_Responsive_Media {

	/**
	 * The single instance of WP_Responsive_Media.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	public function __construct ( $file = '', $version = '1.0.0' ) {
		...
		$this->_token = 'wp_responsive_media';
	...
	public function register_post_type ( $post_type = '', $plural = '', $single = '', $description = '' ) {
		...
		$post_type = new WP_Responsive_Media_Post_Type( $post_type, $plural, $single, $description );
	...
	public function register_taxonomy ( $taxonomy = '', $plural = '', $single = '', $post_types = array() ) {
		...
		$taxonomy = new WP_Responsive_Media_Taxonomy( $taxonomy, $plural, $single, $post_types );
	...
	public function load_localisation () {
		load_plugin_textdomain( 'wp-responsive-media', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
	...
	/**
	 * Main WP_Responsive_Media Instance
	 *
	 * Ensures only one instance of WP_Responsive_Media is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see WP_Responsive_Media()
	 * @return Main WP_Responsive_Media instance
	 */
